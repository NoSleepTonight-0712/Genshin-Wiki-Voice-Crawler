...
if LOAD_CHARACTER_DATA:
    ...
    for r in result:
        ...
        for text, link, filename in voices:
            ...
            cur.execute('insert into dialogue(dialogue_text, dialogue_quest_id, dialogue_audio_url, max_sentence_length, dialogue_audio_name) values (?, ?, ?, ?, ?)', (text, quest_id, link, difficulty_analyze(text), filepath))
